/// <summary>
///   Copied from https://github.com/Azure-App-Service/KuduLite/blob/dev/Kudu.Core/Infrastructure/NaiveFileSystemWatcher.cs
/// </summary>
...
public class LinuxFileSystemWatcher : IFileSystemWatcher, IDisposable
{
    ...
    public LinuxFileSystemWatcher(string path, IEnumerable<string> logFileExtensions)
    {
        this.Path = path;
